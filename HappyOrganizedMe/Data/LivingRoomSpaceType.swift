...
enum LivingRoomSpaceType: String, Codable, CaseIterable, Identifiable, SpaceType {
    ...
    case storageBinsBaskets1 = "Storage Bins & Baskets1"
    case drawers = "Drawers"
    // LivingRoomDecorSpaceType: String, Codable, CaseIterable, Identifiable, SpaceType {
    ...
    // LivingRoomConversationSpaceType: String,  Codable, CaseIterable, Identifiable, SpaceType {
    case seatingArrangement = "Seating Arrangement"
    case coffeeTable = "Coffee Table"
    case accentLighting1 = "Accent Lighting1"
    case decorAccents = "Decor Accents"
    // LivingRoomLightingSpaceType: String, Codable, CaseIterable, Identifiable, SpaceType {
    case overheadLighting = "Overhead Lighting"
    case taskLighting = "Task Lighting"
    case accentLighting2 = "Accent Lighting2"
    ...
    var usageDescription: String {
        ...
        case .accentLighting1: return "Accent lighting adds warmth, depth, and functionality to the living room. It highlights key areas, like seating arrangements or reading nooks, while providing a cozy and welcoming ambiance. Layered lighting creates flexibility, allowing you to adjust the brightness depending on the time of day or occasion."
    ...
    var isCompleted: Bool {
        ...
        case .cabinetsShelves, .storageBinsBaskets1, .drawers: return true
        case .accentLighting1, .plantsGreenery, .shelvesDisplayTables, .wallArtPhotos: return true
        case .playMatActivityArea, .craftArtSupplies, .gameArea, .toyStorage: return true
        case .accentLighting2,.coffeeTable, .decorAccents, .seatingArrangement: return true
    ...
    var subTaskTypes: [SubTaskTypeBox] {
        ...
        case .cabinetsShelves, .storageBinsBaskets1, .drawers:
            return [
                SubTaskTypeBox(LivingRoomSubTaskType.bookshelf)!,
                SubTaskTypeBox(LivingRoomSubTaskType.cornerShelves)!,
                SubTaskTypeBox(LivingRoomSubTaskType.floatingShelves)!,
        ...
        case .accentLighting1,.coffeeTable, .decorAccents, .seatingArrangement:
            return [
                SubTaskTypeBox(LivingRoomSubTaskType.bookshelf)!,
                SubTaskTypeBox(LivingRoomSubTaskType.cornerShelves)!,
                SubTaskTypeBox(LivingRoomSubTaskType.floatingShelves)!,
        ...
        case .accentLighting2, .lightingControls, .overheadLighting, .taskLighting:
            return [
                SubTaskTypeBox(LivingRoomSubTaskType.bookshelf)!,
                SubTaskTypeBox(LivingRoomSubTaskType.cornerShelves)!,
                SubTaskTypeBox(LivingRoomSubTaskType.floatingShelves)!,
