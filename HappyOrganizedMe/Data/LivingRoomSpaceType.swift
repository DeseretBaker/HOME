...
enum LivingRoomSpaceType: String, Codable, CaseIterable, Identifiable, SpaceType {
    ...
    var instructions: String {
        ...
        case .playMatActivityArea:
            return "Place a soft, durable play mat in an open area of the playroom to create a safe, comfortable space for activities like building with blocks, playing with toys, or doing floor puzzles. Ensure the mat is large enough to accommodate multiple activities and easy to clean. Surround the mat with storage solutions to keep toys and games within reach."
        ...
        case .desk:
            return "Place a desk in the center of the living room, ensuring it’s within easy reach of all seating options. Keep the desk free of clutter by limiting decor to a few functional or decorative items, such as a tray, books, or a vase. Ensure the height and size of the desk are proportionate to the seating arrangement for comfort and accessibility."
        }
    }
    var usageDescription: String {
        switch self {
        case .mainSeating:
            return "The main seating is the primary place for relaxing, entertaining guests, or enjoying media. It provides comfort and sets the tone for the room’s overall function, whether for lounging, watching TV, or gathering with friends and family. Its position and size play a key role in defining the room’s layout."
        case .accentChairsOttomans:
            return "Accent chairs and ottomans provide flexibility in seating arrangements. They add style and function to the space, offering additional spots for guests or a more intimate seating option for conversations. Ottomans can also serve as multifunctional pieces for storage, seating, or footrests."
        case .throwPillowBlankets:
        ...
        case .sideTables:
            return "Side tables offer a convenient surface for placing everyday items, such as drinks, snacks, or books, within easy reach while seated. They also serve as a spot for small decorative items or task lighting. Having side tables nearby enhances the functionality and usability of the seating area by making it more practical and comfortable. A side table is a practical addition to the reading zone, offering a surface for placing books, drinks, or small decor items. It enhances the functionality of the space by keeping essentials within arm’s reach, ensuring that you can enjoy your reading or relaxation time without having to move around."
        case .tvMediaConsole:
            return "The TV and media console are central to the entertainment zone, providing a designated space for watching television, streaming content, or playing video games. The console not only supports the TV but also stores essential electronics, helping keep the area organized while maintaining easy access to devices and remotes."
        case .gamingStorage:
            return "This space is used to keep all gaming and media equipment organized and easily accessible. By having everything neatly stored, it ensures quick setup for gaming sessions or watching movies, reducing the frustration of misplaced items while maintaining a clean and organized entertainment area."
        case .soundSystem:
            return "The sound system enhances the audio experience when watching TV, playing video games, or listening to music. Proper placement of the speakers or soundbar provides immersive sound quality, creating an enjoyable entertainment atmosphere. Keeping the system well-organized ensures seamless integration with the rest of the media setup."
        case .decorAroundTv:
            return "The decor around the TV helps soften the visual impact of the media center while adding character to the space. It balances the tech-heavy look of the entertainment area by incorporating personal or aesthetic elements that blend the entertainment zone with the room’s overall style."
        case .chairSeating:
            return "Chair seating in the reading zone provides a comfortable and quiet place to relax and enjoy a book or magazine. It serves as the focal point of the reading area and should offer both comfort and support to make the space inviting for extended periods of reading or relaxation."
        case .storageBinsBaskets:
            return "Storage bins and baskets are essential for keeping the reading and relaxation area organized and free of clutter. They provide a stylish and functional way to store items like extra pillows, blankets, or small reading materials, ensuring everything is within reach without overwhelming the space. Storage bins and baskets are perfect for organizing smaller, loose items, preventing clutter and keeping the room looking neat. They are versatile and can be used in any part of the room, helping to contain various items while maintaining easy access and enhancing the room’s overall organization."
        case .bookshelves:
            return "Bookshelves provide an organized storage solution for books, creating a dedicated space for your reading collection. They also add visual interest to the reading zone and can serve as both functional and decorative elements, showcasing books, plants, or personal items."
        case .decorAroundReading:
            return "The decor around the reading zone adds personality and warmth to the area without overwhelming it. It helps create a serene and comfortable ambiance, making the space feel more inviting while allowing for moments of relaxation and focus."
            
        case .cabinetsShelves:
            return "Cabinets and shelves provide essential storage and organization solutions in a room, allowing you to store larger items while displaying decor and keeping the space clutter-free. Cabinets help conceal items that may not be aesthetically pleasing, while shelves offer both storage and display options for books, photos, or decorative items."
        case .drawers:
            return "Drawers provide hidden storage for items you want to keep out of sight, helping to reduce visual clutter in the room. By organizing items within drawers, you can easily access essentials while maintaining a clean and streamlined space. Drawers are ideal for keeping personal belongings, supplies, or miscellaneous items organized and easy to find."
        case .shelvesDisplayTables:
            return "Shelves and display tables create an opportunity to personalize the space with decorative items while providing functional surfaces for items like lamps or books. They enhance the room’s visual interest and serve as focal points, making the space feel more curated and inviting."
        case .plantsGreenery:
            return "Plants and greenery bring life and vibrancy to a room, helping to create a more natural, relaxed atmosphere. They improve air quality and add color, texture, and warmth to the space. Thoughtfully placed plants can serve as subtle design elements that enhance the overall aesthetic."
        case .wallArtPhotos:
            return "Wall art and photos personalize the room and offer an opportunity to showcase your style and memories. They create focal points and add depth to the walls, making the space feel more complete and visually engaging. Artwork and photos can also help tie the room’s color scheme together."
        case .accentLighting:
            return "Accent lighting enhances the atmosphere of the room by providing soft, ambient light that complements the main lighting. It highlights decorative elements or areas of interest while adding warmth and depth to the space. Accent lighting helps create a cozy, relaxing environment, especially in the evenings. Accent lighting adds warmth, depth, and functionality to the living room. It highlights key areas, like seating arrangements or reading nooks, while providing a cozy and welcoming ambiance. Layered lighting creates flexibility, allowing you to adjust the brightness depending on the time of day or occasion. Accent lighting adds ambiance and highlights specific areas or decor, enhancing the visual interest of the room. It creates a cozy, layered lighting effect that adds depth and dimension to the space, making it feel more intimate and aesthetically pleasing. Accent lighting is perfect for setting the mood or spotlighting key elements of the room."
        case .toyStorage:
        ...
        case .playMatActivityArea:
            return "The play mat activity area serves as the main zone for physical play and creativity. It provides a soft, safe surface for kids to engage in various activities while keeping toys contained in one area. The mat also helps define the space and creates a designated area for play, making the room feel more organized."
        case .craftArtSupplies:
        ...
        case .overheadLighting:
            return "Overhead lighting serves as the primary light source for the room, providing overall illumination and setting the tone for the space. It brightens the entire room, making it suitable for activities that require full visibility, like entertaining guests or cleaning. Dimmable overhead lights allow flexibility, letting you adjust the ambiance to suit the mood or activity."
        case .taskLighting:
    ...
    static var workStudyZoneSpaces: [LivingRoomSpaceType] {
        return [.bookshelves, .chairSeating, .desk]
    }
    static var relaxationZoneSpaces: [LivingRoomSpaceType] {
        return [.accentChairsOttomans, .throwPillowBlankets, .sideTables, .mainSeating]
    }
    static var conversationZoneSpaces: [LivingRoomSpaceType] {
        return [.accentChairsOttomans, .throwPillowBlankets, .sideTables, .mainSeating]
    }
        static var lightingZoneSpaces: [LivingRoomSpaceType] {
            return [.accentLighting, .lightingControls, .overheadLighting, .taskLighting]
        }
        static var furnitureSeatingZoneSpaces: [LivingRoomSpaceType] {
            return [.accentChairsOttomans, .chairSeating, .mainSeating, .seatingArrangement]
        }
        static var furnitureStorageZoneSpaces: [LivingRoomSpaceType] {
            return [.bookshelves, .cabinetsShelves, .coffeeTable, .drawers, .shelvesDisplayTables, .sideTables]
        }
        static var gaminigZoneSpaces: [LivingRoomSpaceType] {
            return [.gameArea, .gamingStorage, .soundSystem, .tvMediaConsole]
        }
        static var decorZoneSpaces: [LivingRoomSpaceType] {
            return [.decorAccents, .decorAroundReading, .decorAroundTv, .plantsGreenery, .storageBinsBaskets, .throwPillowBlankets, .wallArtPhotos]
        }
