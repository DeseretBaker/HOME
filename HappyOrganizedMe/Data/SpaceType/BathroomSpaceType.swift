...
enum BathroomBathingShoweringSpaceType: String, BathroomSpaceType, SpaceType,Codable, CaseIterable, Identifiable {
    ...
    var instructions: String {
        ...
        case .showerCurtainDoor: "Ensure shower curtains or doors are clean and functional. Use a liner to prevent water leakage and mildew."
        }
    }
    ...
    static var allSpaceTypes: [BathroomBathingShoweringSpaceType] {
        return BathroomBathingShoweringSpaceType.allCases
    }
}

enum BathroomToiletZoneSpaceType: String, BathroomSpaceType, SpaceType, Codable, CaseIterable, Identifiable {
    ...
    static var allSpaceTypes: [BathroomToiletZoneSpaceType] {
        return BathroomToiletZoneSpaceType.allCases
    }
    
    enum BathroomVanitySinkZoneSpaceType: String, BathroomSpaceType, SpaceType, Codable, CaseIterable, Identifiable {
        ...
        enum BathroomTowelsToiletriesZoneSpaceType: String, BathroomSpaceType, SpaceType, Codable, CaseIterable, Identifiable {
        ...
        enum BathroomGroomingSpaceType: String, BathroomSpaceType, SpaceType, Codable, CaseIterable, Identifiable {
        ...
        enum BathroomLaundrySpaceType: String, BathroomSpaceType, SpaceType, Codable, CaseIterable, Identifiable {
        ...
        enum BathroomDressingChangingSpaceType: String, BathroomSpaceType, SpaceType, Codable, CaseIterable, Identifiable {
        ...
        enum BathroomCleaningSuppliesSpaceType: String, BathroomSpaceType, SpaceType, Codable, CaseIterable, Identifiable {
        ...
        enum BathroomRelaxationSpaceType: String, BathroomSpaceType, SpaceType, Codable, CaseIterable, Identifiable {
