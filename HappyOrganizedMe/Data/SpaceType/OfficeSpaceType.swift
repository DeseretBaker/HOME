...
enum OfficeDeskStorageSpaceType: String, OfficeSpaceType, SpaceType, Codable, CaseIterable, Identifiable {
...
enum OfficeTechGadgetZoneSpaceType: String, OfficeSpaceType, SpaceType, Codable, CaseIterable, Identifiable {
...
enum OfficeReferenceZoneSpaceType: String, OfficeSpaceType, SpaceType, Codable, CaseIterable, Identifiable {
