...
enum BedroomSpaceType: String, Codable, CaseIterable, Identifiable, SpaceType {
    ...
    var instructions: String {
        ...
        case .topSurface1: return "The top of the dresser can be used for displaying decor like framed photos, plants, or jewelry trays. It should be kept minimal to avoid clutter."
    ...
    var isCompleted: Bool {
        ...
        case .decorativeItems, .drawersShelves, .topSurface1: return true
